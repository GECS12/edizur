...
const I18N = {
  pt: {
    ...
    skipProperty: 'Saltar para o imóvel',
    ...
    emptyListings: 'Não existem imóveis disponíveis neste momento.',
    emptyProjects: 'Ainda não existem projetos publicados.',
    propertyMissing: 'Este imóvel já não está disponível.',
    emptyMap: 'Não existem imóveis com posição no mapa neste momento.',
  ...
  en: {
    ...
    emptyListings: 'There are no properties available right now.',
    emptyProjects: 'No projects published yet.',
    propertyMissing: 'This property is no longer available.',
    emptyMap: 'No mapped properties right now.',
